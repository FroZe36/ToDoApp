...
const addCardModalBtnsContainer = document.querySelector(
  '.addCardModal__btnsContainer',
);
...
const warningModalContainer = document.querySelector(
...
btnFixedCard.addEventListener('click', () => {
  ...
  editElem.firstChild.nextElementSibling.nextElementSibling.innerText =
    textInput.value;
  addCardModal.style.opacity = '0';
  addCardModal.style.top = '-30%';
  titleInput.value = '';
